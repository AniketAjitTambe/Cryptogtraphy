...
public class Client_0 extends rsa
{
	...
	private static void show_keys()
	{
		...
		System.out.println("Client 0 RSA Keys are : Private Key :("+d_key_my+","+n_key_my+")");
		System.out.println("Client 0 RSA Keys are : Public  Key :("+e_key_my+","+n_key_my+") (SENT)");
		
		//Reciever's RSA Keys
		System.out.println("\nClient 1 RSA Keys are : Public  Key :("+e_key_reciever+","+n_key_reciever+") (RECIEVED)");
    ...
    public static void main(String args[]) throws UnknownHostException, IOException
	{
		...
		System.out.println("26 : Press Enter to continue!");
		scn.nextLine();
            ...
            public void run() {
				try{
					...
					if(send_my_key == false)
					{
						...
						System.out.println("Sending Client 0's Public key : "+msg);
						System.out.println("Client 0's Public key sent");
						send_my_key = true;
						dos.writeUTF(msg+"#client 1");						
					}
					...
					if(send_secret_key == false && recieved_reciever_key == true)
					{
						...
						System.out.println("Client 0's Secret Key sent (Encrypted with Reciever's public Key) : "+msg);
						dos.writeUTF(msg+"#client 1");	
					}
				}catch(Exception e){}
            }
            ...
            public void run() {
				try{
						...
						if(msg.substring(0,4).equals("$K-:"))
						{
							...
							System.out.println("Client 1's Public Keys recieved : "+msg);
						...
						if(msg.substring(0,4).equals("$S-:"))
						{
							...
							System.out.println("Client 1's Secret Keys Recieved (Encrypted) : "+msg);
            ...
            public void run() {
                while (true) {
					...
					try {
						...
						//dos.writeUTF(r.encrypt_now("Client 0 > ",sec_key)+msg+"#client 1");
					} catch (IOException e) {
						e.printStackTrace();
					}                    
                }
